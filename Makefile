...
BUNDLE_NAME = ChimeraX-EpitopeMapper
BUNDLE_VERSION = 1.0
...
PKG_NAME = chimerax.epitope_mapper
...
# Updated to point to your actual Python package directory
SOURCE = chimerax/epitope_mapper
